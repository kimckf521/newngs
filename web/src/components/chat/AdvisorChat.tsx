...
const content = {
  ...
  zh: {
    ...
    human: '转人工顾问',
    close: '关闭对话',
    disclaimer: 'AI 助手 —— 涉及费用、报名或你的具体情况，可转接人工顾问。',
    error: '抱歉，智能顾问暂时不可用。点击“转人工顾问”联系我们的团队。',
    // live mode
    liveTitle: '人工顾问',
    liveConnecting: '正在为你接入 NextGen Scholars 团队',
    liveNote: '顾问会在这里直接回复你 —— 工作时间内（北京时间）通常几分钟内答复。',
