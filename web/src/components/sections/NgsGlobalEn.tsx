...
export function NgsGlobalEn() {
  return (
    <section className="programs our-programs__section section-font-style">
      <h2 className="section_title partner-with-ngs__text-center">NGS Global Community</h2>
      <div className="our-programs__grid-cols">
        <a href="#founder" className="partner-with-us__style-1">
        ...
        <a href="#our-programs" className="partner-with-us__style-1">
          <div className="our-programs__style-1">
