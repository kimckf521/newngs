...
export interface HomeStrings {
  ...
  inspires: {
    title: string;
    cards: { img: string; imageAlt: string; title: string; description: string }[];
  };
}
      ...
      cards: [
        {
          ...
          imageAlt: '教育者与 NextGen Scholars 携手助力学生成长',
          title: '成为NGS伙伴',
          description:
        ...
        },
        {
          ...
          imageAlt: '学生在 NextGen Scholars 导师的个性化辅导下学习',
          title: '成为NGS学生',
          description:
        ...
        },
        {
          ...
          imageAlt: '学生加入 NextGen Scholars 全球学习社区',
          title: '加入NGS全球社区',
          description:
      ...
      cards: [
        {
          ...
          imageAlt: '行业领袖在 NextGen Scholars 活动中指导学生',
          title: '全球行业领袖',
          description:
        ...
        },
        {
          ...
          imageAlt: '与 NextGen Scholars 合作的全球顶尖大学校园',
          title: '全球高校直连',
          description:
        ...
        },
        {
          ...
          imageAlt: '学生在 NextGen Scholars SPARK LAB 协作完成项目',
          title: 'SPARK LAB',
          description:
        ...
        },
        {
          ...
          imageAlt: '遍布全球的 NextGen Scholars 学子校友网络',
          title: '全球校友',
          description:
  ...
  en: {
      ...
      cards: [
        {
          ...
          href: '#founder',
          img: '/static/img/partnerwithus.jpg',
          imageAlt: 'Educators partnering with NextGen Scholars to support students',
        ...
        },
        {
          ...
          href: '#our-programs',
          img: '/static/img/Studywithus.jpg',
          imageAlt: 'Student receiving personalised mentorship from a NextGen Scholars mentor',
          title: 'Study With Us',
          description:
        ...
        },
        {
          ...
          img: '/static/img/Joinus.jpg',
          imageAlt: 'Students joining the NextGen Scholars global learning community',
          title: 'Join Us',
          description:
    ...
    inspires: {
      ...
      cards: [
        {
          img: '/static/img/globalindustry.jpg',
          imageAlt: 'Industry leaders mentoring students at a NextGen Scholars session',
        ...
        {
          img: '/static/img/globaluniversities.png',
          imageAlt: 'Campus of a top global university partnered with NextGen Scholars',
        ...
        {
          img: '/static/img/sparklab.jpg',
          imageAlt: 'Students collaborating on a project in the NextGen Scholars SPARK LAB',
          title: 'SPARK LAB',
          description:
        ...
        {
          img: '/static/img/globalalumni.png',
          imageAlt: 'NextGen Scholars alumni network of students worldwide',
          title: 'Global Alumni',
          description:
